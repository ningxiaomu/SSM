        ...
        $.ajax({
            ...
            success:function (data) {
                ...
                for (var i = 0; i <data.result.length; i++) {
                    ...
                    $tr.append("<td>"+"<div class=\"layui-unselect layui-form-checkbox\" lay-skin=\"primary\">"+"<i class=\"layui-icon layui-icon-ok\">"+"</i>"+"</div>"+"</td>"+"<td>"+userid+"</td>"+"<td>"+data.result[i].username+"</td>"+"<td>"+data.result[i].password+"</td>"+"<td>"+data.result[i].email+"</td>"+"<td>"+data.result[i].phoneNum+"</td>"+"<td>"+time+"</td>"+"<td class='"+statusStrCss+"' style='text-decoration: none;text-align:center'>"+data.result[i].statusStr+"</td>"+"<td>"+"<a title='编辑' id='"+userid+"'' >"+"<i class=\"layui-icon\">&#xe642;</i>"+"</a>"+"<a title='删除' id='"+userid+"' onclick='delCase(this.id)'>"+"<i class=\"layui-icon\">&#xe640;</i>"+"</a>"+"</td>")
