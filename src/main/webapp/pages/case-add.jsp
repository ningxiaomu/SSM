                ...
                <form class="layui-form" id="saveCase" action="##" method="post">
                    ...
                    <div class="layui-form-item">
                        <label for="need_login" class="layui-form-label">
                            <span class="x-red">*</span>need_login
                        </label>
                        <div class="layui-input-inline">
<%--                            <input type="checkbox" name="need_login" id="need_login" lay-text="是|否"  checked="" lay-skin="switch" onchange="need_login()">--%>
                        ...
                        <div class="layui-form-mid layui-word-aux">
                            <span class="x-red">*</span>是否需要登陆(备注：如果是同一个项目，只需要一条用例填好即可)
                        </div>
                    </div>
                    <!--需要登陆的接口地址-->
<%--                    <div class="layui-form-item" id="needloginaddress" style="display:none">--%>
<%--                        <label for="loginaddress" class="layui-form-label">--%>
<%--                            <span class="x-red">*</span>登陆的地址--%>
<%--                        </label>--%>
<%--                        <div class="layui-input-inline">--%>
<%--                            <input type="text" id="loginaddress" name="loginaddress" required="" lay-verify="email"--%>
<%--                                   autocomplete="off" class="layui-input">--%>
<%--                        </div>--%>
<%--                        <div class="layui-form-mid layui-word-aux">--%>
<%--                            <span class="x-red">*</span>必填--%>
...
<%--                    </div>--%>
<%--                    <!--需要登陆的参数-->--%>
<%--                    <div class="layui-form-item" id="need_loginpar" style="display:none">--%>
<%--                        <label for="loginpar" class="layui-form-label">--%>
<%--                            <span class="x-red">*</span>登陆的参数--%>
<%--                        </label>--%>
<%--                        <div class="layui-input-inline">--%>
<%--                            <input type="text" id="loginpar" name="loginpar" required="" lay-verify="email"--%>
<%--                                   autocomplete="off" class="layui-input">--%>
<%--                        </div>--%>
<%--                        <div class="layui-form-mid layui-word-aux">--%>
<%--                            <span class="x-red">*</span>比如：username=admin;password=1;refer=/zendao/--%>
<%--                        </div>--%>
<%--                    </div>--%>
        ...
        <script>
            layui.use(['form'], function() {
                ...
                form.on('select(needlogin)', function(data){
                    ...
                    if(val=="是"){
                        $("#needloginaddress").removeAttr("style");
                        $("#need_loginpar").removeAttr("style");
                    }else if(val=="否"){
                        $("#needloginaddress").attr("style","display:none");
