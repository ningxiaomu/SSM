                        ...
                        <div class="layui-card-body ">
                            <form class="layui-form" id="findAppointCase" class="layui-form" action="##" method="post">
                                <div class="layui-inline layui-show-xs-block">
                                    <label for="projectSelect" class="layui-form-label" >按照项目查询</label>
                                    <div class="layui-input-inline">
                                        <select  id="projectSelect" name="projectSelect" lay-verify="required" lay-filter="xmFilter">
                                        </select>
                                    </div>
...
<%--                                    <button id="testbtn1" onclick="next_page()" class="layui-btn">btn</button>--%>
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <label for="projectSelect" class="layui-form-label" >按照条件查询</label>
                                    <div class="layui-input-inline">
                                        <select  id="conditionSelect" name="conditionSelect" lay-verify="required" lay-filter="xmFilter">
<%--                                            <option>caseid</option>--%>
                                            <option>接口名称</option>
                                        </select>
                                        <input type="text" width="300" class="layui-input" id="conditionValue" name="conditionValue" lay-verify="required">
                                    </div>
                                    <input type="button" class="layui-btn" value="搜索" id="condition_repass" onclick="case_conditionSelect(this,conditionSelect,conditionValue)">
                                </div>
...
<%--                                  <th>登陆参数</th>--%>
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    for (var i = 0; i < data.result.length; i++) {
                        ...
                        var need_login=data.result[i].need_login
                        var need_loginadd=data.result[i].loginaddress
                        var loginpar=data.result[i].loginpar
                        ...
                        var statusStrCss;
                        var date = new Date(data.result[i].joinTime);
                        Y = date.getFullYear() + '-';
                        ...
                        $tr.append("</td>"+"<td>"+caseid+"</td>"+"<td>"+caseName+"</td>"+"<td>"+project+"</td>"+"<td>"+domain+"</td>"+"<td>"+requestAddress+"</td>"+"<td>"+method+"</td>"+"<td>"+contentType+"</td>"+"<td>"+need_login+"</td>"+"<td>"+parameter+"</td>"+"<td>"+exResult+"<td>"+time+"</td>"+"<td class='"+statusStrCss+"' >"+statusStr+"</td>"+"<td>"+"<a title='编辑"+"'  onclick='xadmin.open(\"编辑用例\",\"case-edit.jsp?caseid="+caseid+"&caseName="+caseName+"&project="+project+"&domain="+domain+"&requestAddress="+requestAddress+"&method="+method+"&contentType="+contentType+"&need_login="+need_login+"&parameter="+parameter+"&exResult="+exResult+"&status="+status+"\",800,600)' >"+"<i class=\"layui-icon\">&#xe642;</i>"+"</a>"+"<a title='删除' id='"+caseid+"' onclick='delCase(this.id)'>"+"<i class=\"layui-icon\">&#xe640;</i>"+"</a>"+"</td>")
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        ...
                        for (var i = 0; i <data.result.length; i++) {
                           ...
                           // $tr.append("</td>"+"<td>"+caseid+"</td>"+"<td>"+caseName+"</td>"+"<td>"+project+"</td>"+"<td>"+domain+"</td>"+"<td>"+requestAddress+"</td>"+"<td>"+method+"</td>"+"<td>"+contentType+"</td>"+"<td>"+need_login+"</td>"+"<td>"+need_loginadd+"</td>"+"<td>"+loginpar+"</td>"+"<td>"+parameter+"</td>"+"<td>"+exResult+"<td class='"+statusStrCss+"' >"+statusStr+"</td>"+"<td>"+"<a title='编辑"+"'  onclick='xadmin.open(\"编辑用例\",\"case-edit.jsp?caseid="+caseid+"&caseName="+caseName+"&project="+project+"&domain="+domain+"&requestAddress="+requestAddress+"&method="+method+"&contentType="+contentType+"&need_login="+need_login+"&need_loginadd="+need_loginadd+"&loginpar="+loginpar+"&parameter="+parameter+"&exResult="+exResult+"&status="+status+"\",800,600)' >"+"<i class=\"layui-icon\">&#xe642;</i>"+"</a>"+"<a title='删除' id='"+caseid+"' onclick='delCase(this.id)'>"+"<i class=\"layui-icon\">&#xe640;</i>"+"</a>"+"</td>")
                            $tr.append("</td>"+"<td>"+caseid+"</td>"+"<td>"+caseName+"</td>"+"<td>"+project+"</td>"+"<td>"+domain+"</td>"+"<td>"+requestAddress+"</td>"+"<td>"+method+"</td>"+"<td>"+contentType+"</td>"+"<td>"+need_login+"</td>"+"<td>"+parameter+"</td>"+"<td>"+exResult+"<td>"+time+"</td>"+"<td class='"+statusStrCss+"' >"+statusStr+"</td>"+"<td>"+"<a title='编辑"+"'  onclick='xadmin.open(\"编辑用例\",\"case-edit.jsp?caseid="+caseid+"&caseName="+caseName+"&project="+project+"&domain="+domain+"&requestAddress="+requestAddress+"&method="+method+"&contentType="+contentType+"&need_login="+need_login+"&parameter="+parameter+"&exResult="+exResult+"&status="+status+"\",800,600)' >"+"<i class=\"layui-icon\">&#xe642;</i>"+"</a>"+"<a title='删除' id='"+caseid+"' onclick='delCase(this.id)'>"+"<i class=\"layui-icon\">&#xe640;</i>"+"</a>"+"</td>")
    ...
    <script>
        ...
        function case_conditionSelect(obj,conditionSelect,conditionValue) {
            ...
            $.ajax({
                type:'POST',
                dataType:'json',
                url:"/case/findConditionCase?size=10&page=1&conditionValue="+conditionValue+"&conditionSelect="+conditionSelect,
                data:JSON.stringify(formObject),
                contentType:'application/json;charset=utf-8',
                success:function (data) {
                    console.log(data)
